...
PreparedQueryOptions.prototype.$filter = function (filter) {
    if (filter && (typeof filter === 'string' || (Predicate && filter instanceof Predicate))) {
...
PreparedQueryOptions.prototype.parseOptions = function() {
    ...
    for (argument in this.arguments) {
        if (this.arguments.hasOwnProperty(argument)) {
            appendSeparator();
            if (Predicate && this.arguments[argument] instanceof Predicate && typeof this.arguments[argument].parsePredicate === 'function') {
